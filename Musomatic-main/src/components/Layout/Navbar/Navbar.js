...
import "./navbar.css";
import logo_crop from "../../../assets/logo_crop.jpeg";
	...
	return (
		<nav className="navbar navbar-expand-md navbar-light fixed-top shadow-md">
			...
			<div className="d-flex w-50 order-0">
				<Link to={"/"}>
					<img src={logo_crop} alt="logo" className="mb-md-1 mb-3 cursor_ptr nav_logo" width="150" />
				</Link>
			</div>
								...
								<div className="row">
									<div className="mt-4 offset-lg-1 col-lg-2 offset-md-1 col-md-2 offset-0 col-12 logo_div_anim">
										<Link to={"/"} onClick={closeNavbar}>
											<img src={logo_crop} alt="White logo" className="hamburger_logo_mxv" />
										</Link>
									</div>
											...
											<div className="row justify-content-center">
												<div className="col-md-3 col-6 text-center">
													...
													<div className="row ham_menu_hover_effect_row mt-md-5 mt-4 justify-content-center">
														<Link to={"/library"} onClick={closeNavbar} className="ham_menu_link ham_menu_hover_effect text-center">
															<div>Library</div>
														</Link>
													</div>
													<div className="row ham_menu_hover_effect_row justify-content-center">
														<Link to={"/trending"} onClick={closeNavbar} className="ham_menu_link ham_menu_hover_effect text-center">
															<div>Trending</div>
														</Link>
													</div>
													<div className="row ham_menu_hover_effect_row justify-content-center">
												...
												<div className="col-md-3 col-6 text-center">
													...
													<div className="row ham_menu_hover_effect_row mt-md-5 mt-4 justify-content-center">
														<Link to={"/dashboard"} onClick={closeNavbar} className="ham_menu_link ham_menu_hover_effect text-center">
															<div>Dashboard</div>
														</Link>
													</div>
													<div className="row ham_menu_hover_effect_row justify-content-center">
														<Link to={"/"} onClick={closeNavbar} className="ham_menu_link ham_menu_hover_effect text-center">
															<div>Home</div>
														</Link>
													</div>
													<div className="row ham_menu_hover_effect_row justify-content-center">
														<Link to={"/create"} onClick={closeNavbar} className="ham_menu_link ham_menu_hover_effect text-center">
															<div>Create</div>
														</Link>
													</div>
												</div>
												...
												<div className="col-md-3 col-12 text-center">
													...
													<div className="row ham_menu_hover_effect_row mt-md-5 mt-4 justify-content-center">
														<Link to={"/contact-us"} onClick={closeNavbar} className="ham_menu_link ham_menu_hover_effect text-center">
															<div>Contact Us</div>
														</Link>
													</div>
													{/* <div className="row ham_menu_hover_effect_row justify-content-center">
														<Link to={"/bugs"} onClick={closeNavbar} className="ham_menu_link ham_menu_hover_effect text-center">
								...
								<div className="row justify-content-center mt-md-5 mb-5 harmburger_menu_connect">
									<div className="ham_menu_connect_links_md col-md-2 offset-0 col-12 mt-md-0 mt-4">
										...
										<div className="row justify-content-center mt-3">
											<a href="#/" target="_blank" rel="noopener noreferrer" className="connect_link cursor_ptr text-center col p-0">
