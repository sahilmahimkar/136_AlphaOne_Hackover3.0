...
export default function Hero() {
	...
	const fadeImages_m = [hero1_m, hero2_m, hero3_m];
			...
			{/* <Fade {...properties}> */}
				<div className="each-fade">
					<div className="image-container">
						<img className="hero-container-new" src="https://www.androidauthority.com/wp-content/uploads/2021/05/Rocket-Player-screenshot-2022.jpg" alt="" />
